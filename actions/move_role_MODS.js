module.exports = {
  ...
  subtitle(data, presets) {
    return `${presets.getRoleText(data.storage, data.varName)} mover para a posição "${data.posicao}"`;
  },
...
<role-input dropdownLabel="Cargo" selectId="storage" variableContainerId="varNameContainer" variableInputId="varName"></role-input>
<br><br><br>
