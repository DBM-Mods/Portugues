module.exports = {
  ...
  subtitle(data) {
    ...
    if(data.descriptionx == true){
      ...
      const type = ['Reta', 'Circulo']
      const index = parseInt(data.type)

    return data.description
    ? `<font style="color:${desccor}">${data.description}</font>`
    : `<font style="color:${desccor}">Barra de progresso ${type[index]} - ${storeTypes[parseInt(data.storage)]} (${data.varName})</font>`
  },
...
<span class="dbminputlabel">Altura da barra</span><br>
