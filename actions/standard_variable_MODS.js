...
<br><br><br>
  ...
  <br>
  <span class="dbminputlabel">Definir como padrão se</span><br>
  <div style="background:rgba(255,255,255,0.1);padding:8px;overflow: hidden;">
  <dbm-checkbox id="und" style="float:left;padding:2px 0px" label="For undefined"></dbm-checkbox>
  <dbm-checkbox style="float:left;padding:2px 0px" id="null" label="For null/undefined" checked></dbm-checkbox>
  <dbm-checkbox style="float:left;padding:2px 0px" id="NaN" label="For NaN/null/undefined"></dbm-checkbox>
  <dbm-checkbox style="float:left;padding:2px 0px" id="false" label="For false"></dbm-checkbox>
  <dbm-checkbox style="float:left;padding:2px 0px" id="nolista" label="Não for uma lista"></dbm-checkbox>
</div>
  </div>
