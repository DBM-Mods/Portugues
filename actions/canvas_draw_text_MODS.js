	...
	<div style="padding-top:12px">
		...
		<span class="dbminputlabel">Tipo de Borda</span><br>
			...
			<option value="0" selected>Nenhuma</option>
				<option value="1">Borda Cor (HEX ou RGBA)</option>
				<option value="2">Borda Gradiente</option>
		</select>
...
<div id="bordadoxinxyla" style="padding-top:15px">
	...
	<tab label="Sombra" icon="image">
		...
		<option value="0" selected>Nenhuma</option>
			<option value="1">Sombra Cor (HEX ou RGBA)</option>
	</select>
	<div id="shadow" style="padding-top:15px">
	<table style="width:100%"><tr>
	<td style="width:100px">
	<span class="dbminputlabel">Borrar da Sombra</span><br>
...
<span class="dbminputlabel">Tipo de Largura</span>
<div style="width:100%;background:rgba(50,50,50,0.5);-webkit-border-radius: 10px;-moz-border-radius: 10px;border-radius: 10px;padding:8px 4px">
<select id="menulargura" class="round" onchange="glob.onChange1(this)">
<option value="0" selected>Nenhuma</option>
<option value="1">Largura Fixa</option>
<option value="2">Largura Máxima</option>
<option value="3">Largura Máxima sem quebra de palavras</option>
</select>
...
<td style="width:50%">
<span class="dbminputlabel">Altura de distancia</span><br>
